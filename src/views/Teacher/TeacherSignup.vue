<template>
  <div class="signup-container">
    ...
    <p>Please fill in the information below to sign up as a teacher:</p>
    <form @submit.prevent="submitForm" class="signup-form">
      ...
      <div class="form-group">
        ...
        <select id="subject" v-model="formData.subject_id" required>
          <option value="" disabled>Select Subject</option>
          <option v-for="subject in subjects" :key="subject.id" :value="subject.id">
            {{ subject.subject_name }}  <!-- Changed from name to subject_name -->
          </option>
        </select>
      </div>
  ...
  methods: {
    ...
    async fetchSubjects() {
      try {
        ...
        this.subjects = response.data.data;  // Assuming subjects are returned in 'data'
